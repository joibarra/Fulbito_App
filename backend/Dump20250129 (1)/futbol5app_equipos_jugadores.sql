...
CREATE TABLE `equipos_jugadores` (
  ...
  CONSTRAINT `equipos_jugadores_ibfk_1` FOREIGN KEY (`id_equipo`) REFERENCES `equipos` (`id`),
  CONSTRAINT `equipos_jugadores_ibfk_2` FOREIGN KEY (`id_jugador`) REFERENCES `jugadores` (`id`)
